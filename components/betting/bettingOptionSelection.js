...
const BettingOptionSelection = ({_bettingDatesStore}) => {
    ...
    console.log("BettingOptionSelection:bettingInitData " ,bettingInitData)
      function ticketSubmission(){
        console.log("DATA: ", ticketSubmissionData);
      }
        ...
        <div className="table-scalable my-3">
            <table className="">
                ...
                <tr>
                    ...
                    <td colSpan="2">
                            <button  data-bs-toggle="modal" data-bs-target="#bettingModal" type="button" className="btn-custom-curve2" onClick={ticketSubmission}>Submit</button>
                    </td>
                </tr>
                </tbody>
            </table>
